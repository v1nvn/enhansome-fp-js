# Awesome FP JS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,352 | 🐛 69 | 📅 2026-01-28 with stars
...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,608 | 🐛 107 | 🌐 JavaScript | 📅 2026-02-06 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,608 | 🐛 107 | 🌐 JavaScript | 📅 2026-02-06 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
* [Ramda](https://github.com/ramda/ramda) ⭐ 24,106 | 🐛 147 | 🌐 JavaScript | 📅 2026-01-22 – A practical functional library for JavaScript that is designed specifically for a functional programming style. A style that makes it easy to create functional pipelines and never mutates user data. +TS.
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 14,744 | 🐛 61 | 🌐 TypeScript | 📅 2026-02-03 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 13,160 | 🐛 479 | 🌐 TypeScript | 📅 2026-02-08 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
...
* [true-myth](https://github.com/true-myth/true-myth) ⭐ 1,318 | 🐛 14 | 🌐 TypeScript | 📅 2026-02-10 A library for safe, idiomatic null and error handling in TypeScript, with `Maybe` and `Result` types, supporting both a functional style and a more traditional method-call style
...
* [TGrid](https://github.com/samchon/tgrid) ⭐ 166 | 🐛 4 | 🌐 TypeScript | 📅 2025-12-18 - Grid Computing Framework, Network & Thread extension of [TSTL](https://github.com/samchon/tstl) ⭐ 634 | 🐛 3 | 🌐 TypeScript | 📅 2025-08-13, supporting RFC (Remote Function Call). +TS.
...
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,871 | 🐛 46 | 🌐 JavaScript | 📅 2026-02-10 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
* [Lazy.js](https://github.com/dtao/lazy.js) ⭐ 5,993 | 🐛 59 | 🌐 JavaScript | 📅 2020-07-15 – A utility library with a lazy engine under the hood that strives to do as little work as possible while being as flexible as possible.
...
* [TSTL](https://github.com/samchon/tstl) ⭐ 634 | 🐛 3 | 🌐 TypeScript | 📅 2025-08-13 - C++ STL (Standard Template Library) is implemented in TypeScript. STL Containers, iterators, algorithms and functors, that following functional programming rule, are provided. +TS.
...
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,149 | 🐛 72 | 🌐 TypeScript | 📅 2025-08-20 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
...
* [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,380 | 🐛 6 | 🌐 Clojure | 📅 2026-02-02 – Compiles [Clojure](http://clojure.org/), a hosted Lisp with immutable persistent data structures, to JavaScript.
...
* [tk-learning-center/Functional Programming Learning Path](https://github.com/tk-learning-center/functional-programming-learning-path) ⭐ 1,036 | 🐛 1 | 🌐 Clojure | 📅 2024-10-22 - A Learning Path for Functional Programming
