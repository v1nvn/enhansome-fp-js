# Awesome FP JS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 443,829 | 🐛 75 | 📅 2026-03-04 with stars
...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,580 | 🐛 127 | 🌐 JavaScript | 📅 2026-02-23 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,580 | 🐛 127 | 🌐 JavaScript | 📅 2026-02-23 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
...
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 14,817 | 🐛 62 | 🌐 TypeScript | 📅 2026-03-05 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 13,442 | 🐛 506 | 🌐 TypeScript | 📅 2026-03-05 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
...
* [rubico](https://github.com/a-synchronous/rubico) ⭐ 283 | 🐛 42 | 🌐 JavaScript | 📅 2026-03-06 - 🏞 \[a]synchronous functional syntax
...
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,268 | 🐛 72 | 🌐 TypeScript | 📅 2026-02-14 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
...
* [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,383 | 🐛 6 | 🌐 Clojure | 📅 2026-03-08 – Compiles [Clojure](http://clojure.org/), a hosted Lisp with immutable persistent data structures, to JavaScript.
