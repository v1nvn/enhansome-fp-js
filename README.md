# Awesome FP JS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 458,031 | 🐛 67 | 📅 2026-04-19 with stars
...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,254 | 🐛 139 | 🌐 JavaScript | 📅 2026-04-22 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,254 | 🐛 139 | 🌐 JavaScript | 📅 2026-04-22 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
...
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 14,956 | 🐛 66 | 🌐 TypeScript | 📅 2026-04-10 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 13,920 | 🐛 518 | 🌐 TypeScript | 📅 2026-04-22 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
...
* [futil-js](https://github.com/smartprocure/futil-js) ⭐ 1,044 | 🐛 34 | 🌐 JavaScript | 📅 2024-05-02 - A collection of functional utilities that could conceivably be part of a library like lodash/fp, but for some reason or other are not.
...
* [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,067 | 🐛 125 | 🌐 TypeScript | 📅 2026-04-10 – Immutable persistent data collections.
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,920 | 🐛 61 | 🌐 JavaScript | 📅 2026-04-14 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
...
* [Mori](https://github.com/swannodette/mori) ⭐ 3,368 | 🐛 64 | 🌐 Clojure | 📅 2026-03-06 – ClojureScript’s persistent data structures and supporting API from the comfort of vanilla JavaScript.
...
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,441 | 🐛 73 | 🌐 TypeScript | 📅 2026-02-14 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
...
* [immutable-ext](https://github.com/DrBoolean/immutable-ext) ⭐ 489 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-10 – FantasyLand extensions for [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,067 | 🐛 125 | 🌐 TypeScript | 📅 2026-04-10.
