# Awesome FP JS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 454,332 | 🐛 60 | 📅 2026-04-02 with stars
...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,325 | 🐛 140 | 🌐 JavaScript | 📅 2026-04-01 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,325 | 🐛 140 | 🌐 JavaScript | 📅 2026-04-01 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
* [Ramda](https://github.com/ramda/ramda) ⭐ 24,090 | 🐛 146 | 🌐 JavaScript | 📅 2026-01-22 – A practical functional library for JavaScript that is designed specifically for a functional programming style. A style that makes it easy to create functional pipelines and never mutates user data. +TS.
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 14,932 | 🐛 65 | 🌐 TypeScript | 📅 2026-04-10 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 13,804 | 🐛 522 | 🌐 TypeScript | 📅 2026-03-31 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
...
* [Rambda](https://github.com/selfrefactor/rambda) ⭐ 1,752 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-06 - A faster alternative to Ramda in under 10kB.
* [js-joda](https://github.com/js-joda/js-joda) ⭐ 1,656 | 🐛 15 | 🌐 JavaScript | 📅 2026-04-11 – An immutable date and time library that provides a simple, domain-driven and clean API based on the ISO8601 calendar.
...
* [TGrid](https://github.com/samchon/tgrid) ⭐ 166 | 🐛 4 | 🌐 TypeScript | 📅 2025-12-18 - Grid Computing Framework, Network & Thread extension of [TSTL](https://github.com/samchon/tstl) ⭐ 630 | 🐛 3 | 🌐 TypeScript | 📅 2025-08-13, supporting RFC (Remote Function Call). +TS.
...
* [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,077 | 🐛 124 | 🌐 TypeScript | 📅 2026-04-10 – Immutable persistent data collections.
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,910 | 🐛 60 | 🌐 JavaScript | 📅 2026-04-08 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
* [Lazy.js](https://github.com/dtao/lazy.js) ⭐ 5,982 | 🐛 59 | 🌐 JavaScript | 📅 2020-07-15 – A utility library with a lazy engine under the hood that strives to do as little work as possible while being as flexible as possible.
...
* [TSTL](https://github.com/samchon/tstl) ⭐ 630 | 🐛 3 | 🌐 TypeScript | 📅 2025-08-13 - C++ STL (Standard Template Library) is implemented in TypeScript. STL Containers, iterators, algorithms and functors, that following functional programming rule, are provided. +TS.
...
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,409 | 🐛 73 | 🌐 TypeScript | 📅 2026-02-14 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
* [Sanctuary](https://github.com/plaid/sanctuary) ⭐ 3,055 | 🐛 36 | 🌐 JavaScript | 📅 2024-11-10 – Sanctuary makes it possible to write safe code without null checks.  +CT, +TS.
...
* [immutable-ext](https://github.com/DrBoolean/immutable-ext) ⭐ 489 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-10 – FantasyLand extensions for [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,077 | 🐛 124 | 🌐 TypeScript | 📅 2026-04-10.
...
* [lucasviola/Awesome Functional Programming](https://github.com/lucasviola/awesome-functional-programming) ⭐ 998 | 🐛 1 | 📅 2024-04-22 – Awesome resources on functional programming theory and learning materials.
