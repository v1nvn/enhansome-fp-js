# Awesome FP JS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 465,427 | 🐛 73 | 📅 2026-05-05 with stars
...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,224 | 🐛 141 | 🌐 JavaScript | 📅 2026-05-08 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,224 | 🐛 141 | 🌐 JavaScript | 📅 2026-05-08 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
...
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 14,988 | 🐛 68 | 🌐 TypeScript | 📅 2026-05-09 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 14,149 | 🐛 536 | 🌐 TypeScript | 📅 2026-05-11 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
...
* [Rambda](https://github.com/selfrefactor/rambda) ⭐ 1,754 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-25 - A faster alternative to Ramda in under 10kB.
...
* [true-myth](https://github.com/true-myth/true-myth) ⭐ 1,338 | 🐛 14 | 🌐 TypeScript | 📅 2026-05-11 A library for safe, idiomatic null and error handling in TypeScript, with `Maybe` and `Result` types, supporting both a functional style and a more traditional method-call style
...
* [rubico](https://github.com/a-synchronous/rubico) ⭐ 283 | 🐛 51 | 🌐 JavaScript | 📅 2026-05-08 - 🏞 \[a]synchronous functional syntax
...
* [Ditox.js](https://github.com/mnasyrov/ditox) ⭐ 101 | 🐛 1 | 🌐 TypeScript | 📅 2026-02-23 - Powerful dependency injection container for building modular apps. +TS
...
* [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,061 | 🐛 124 | 🌐 TypeScript | 📅 2026-05-09 – Immutable persistent data collections.
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,937 | 🐛 46 | 🌐 JavaScript | 📅 2026-05-09 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
...
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,485 | 🐛 73 | 🌐 TypeScript | 📅 2026-02-14 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
...
* [immutable-ext](https://github.com/DrBoolean/immutable-ext) ⭐ 488 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-10 – FantasyLand extensions for [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,061 | 🐛 124 | 🌐 TypeScript | 📅 2026-05-09.
...
* [Functional Programming Resources In JavaScript](https://github.com/busypeoples/functional-programming-javascript) ⭐ 303 | 🐛 2 | 📅 2020-10-01
