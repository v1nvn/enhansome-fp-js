# Awesome FP JS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 444,521 | 🐛 75 | 📅 2026-03-09 with stars
...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,577 | 🐛 131 | 🌐 JavaScript | 📅 2026-02-23 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,577 | 🐛 131 | 🌐 JavaScript | 📅 2026-02-23 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
* [Ramda](https://github.com/ramda/ramda) ⭐ 24,098 | 🐛 146 | 🌐 JavaScript | 📅 2026-01-22 – A practical functional library for JavaScript that is designed specifically for a functional programming style. A style that makes it easy to create functional pipelines and never mutates user data. +TS.
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 14,823 | 🐛 62 | 🌐 TypeScript | 📅 2026-03-05 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 13,469 | 🐛 504 | 🌐 TypeScript | 📅 2026-03-10 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
...
* [js-joda](https://github.com/js-joda/js-joda) ⭐ 1,654 | 🐛 17 | 🌐 JavaScript | 📅 2026-03-01 – An immutable date and time library that provides a simple, domain-driven and clean API based on the ISO8601 calendar.
...
* [true-myth](https://github.com/true-myth/true-myth) ⭐ 1,325 | 🐛 14 | 🌐 TypeScript | 📅 2026-02-11 A library for safe, idiomatic null and error handling in TypeScript, with `Maybe` and `Result` types, supporting both a functional style and a more traditional method-call style
* [fxts](https://github.com/marpple/FxTS) ⭐ 1,153 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-19 - Lazy evaluation and concurrency. +TS
* [futil-js](https://github.com/smartprocure/futil-js) ⭐ 1,045 | 🐛 34 | 🌐 JavaScript | 📅 2024-05-02 - A collection of functional utilities that could conceivably be part of a library like lodash/fp, but for some reason or other are not.
* [1-liners](https://github.com/1-liners/1-liners) ⭐ 800 | 🐛 28 | 🌐 JavaScript | 📅 2023-04-16 – Functional tools that couldn’t be simpler. A dead simple functional utility belt, hand-crafted with love and attention.  -TS.
* [Ramda Adjunct](https://github.com/char0n/ramda-adjunct) ⭐ 685 | 🐛 80 | 🌐 JavaScript | 📅 2026-02-28 is a community-maintained extension of Ramda.
...
* [rubico](https://github.com/a-synchronous/rubico) ⭐ 283 | 🐛 43 | 🌐 JavaScript | 📅 2026-03-06 - 🏞 \[a]synchronous functional syntax
...
* [iter-tools](https://github.com/iter-tools/iter-tools) ⭐ 183 | 🐛 16 | 🌐 JavaScript | 📅 2025-06-02 - a rich toolset for working with iterables, both sync and async. +TS.
...
* [tinyeffect](https://github.com/Snowflyt/tinyeffect) ⭐ 33 | 🐛 0 | 🌐 TypeScript | 📅 2025-03-30 - A tiny TypeScript library for handling side effects in a unified way using algebraic effects. +TS
* [rocket-pipes](https://github.com/darky/rocket-pipes) ⭐ 26 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-28 - Powerful pipes, that chain Promise and ADT like Maybe or Either from popular FP libraries. +TS
...
* [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,097 | 🐛 121 | 🌐 TypeScript | 📅 2026-03-06 – Immutable persistent data collections.
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,906 | 🐛 48 | 🌐 JavaScript | 📅 2026-03-06 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
...
* [Mori](https://github.com/swannodette/mori) ⭐ 3,374 | 🐛 64 | 🌐 Clojure | 📅 2026-03-06 – ClojureScript’s persistent data structures and supporting API from the comfort of vanilla JavaScript.
* [Baobab](https://github.com/Yomguithereal/baobab) ⭐ 3,162 | 🐛 49 | 🌐 JavaScript | 📅 2022-05-10 – persistent and optionally immutable data tree with cursors.
...
* [imlazy](https://github.com/benji6/imlazy) ⭐ 104 | 🐛 2 | 🌐 JavaScript | 📅 2026-03-05 – Library for creating and manipulating lazy iterables using the ES2015 iteration protocols.
...
* [Fantasy Land](https://github.com/fantasyland/fantasy-land) ⭐ 10,226 | 🐛 36 | 🌐 JavaScript | 📅 2024-11-10 – Not a library, but a specification of the Monad laws for libraries to follow.
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,293 | 🐛 72 | 🌐 TypeScript | 📅 2026-02-14 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
...
* [crocks](https://github.com/evilsoft/crocks) ⭐ 1,598 | 🐛 68 | 🌐 JavaScript | 📅 2023-01-06 – A collection of popular Algebraic Data Types with the main goal to curate and provide not only a common interface between each type, but also all of the helper functions needed to hit the ground running. -TS.
* [purify](https://github.com/gigobyte/purify) ⭐ 1,598 | 🐛 2 | 🌐 TypeScript | 📅 2025-12-16 - Functional programming library for TypeScript focusing on ADTs.  +CT, +TS.
...
* [immutable-ext](https://github.com/DrBoolean/immutable-ext) ⭐ 489 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-10 – FantasyLand extensions for [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,097 | 🐛 121 | 🌐 TypeScript | 📅 2026-03-06.
...
* [lenses](https://github.com/DrBoolean/lenses) ⭐ 216 | 🐛 3 | 🌐 JavaScript | 📅 2015-09-28 – Composable [kmett](https://github.com/ekmett/lens) ⭐ 2,077 | 🐛 110 | 🌐 Haskell | 📅 2026-03-02 style lenses.
...
* [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,384 | 🐛 6 | 🌐 Clojure | 📅 2026-03-08 – Compiles [Clojure](http://clojure.org/), a hosted Lisp with immutable persistent data structures, to JavaScript.
...
* [ElixirScript](https://github.com/bryanjos/elixirscript) ⭐ 1,568 | 🐛 19 | 🌐 Elixir | 📅 2019-08-20 – Compiles a subset of [Elixir](http://elixir-lang.org/), a dynamic, functional language designed for building scalable and maintainable applications, to JavaScript.
...
* [Functional Programming Jargon](https://github.com/hemanth/functional-programming-jargon) ⭐ 18,657 | 🐛 27 | 📅 2023-10-17 – Jargon from the functional programming world explained in JavaScript.
* [You don't (may not) need loops ➿](https://github.com/you-dont-need/You-Dont-Need-Loops) ⭐ 1,168 | 🐛 5 | 📅 2024-10-15 - Loops are one of the first constructs that junior programmers learn, but they can pose many potential issues in the software development process, and could be avoided in many cases.
...
* [functional-javascript-workshop](https://github.com/timoxley/functional-javascript-workshop) ⭐ 2,043 | 🐛 83 | 🌐 JavaScript | 📅 2020-10-08 – The goal of this workshop is to create realistic problems that can be solved using terse, vanilla, idiomatic JavaScript to teach fundamental functional programming features of JavaScript.
* [cube-composer](https://github.com/sharkdp/cube-composer) ⭐ 2,030 | 🐛 10 | 🌐 PureScript | 📅 2022-12-08 – A puzzle game inspired by functional programming.
* [functional-frontend-architecture](https://github.com/paldepind/functional-frontend-architecture) ⭐ 1,443 | 🐛 9 | 🌐 JavaScript | 📅 2019-07-02 – A functional frontend framework. Based on Ramda + union-type-js + Flyd + Snabbdom
