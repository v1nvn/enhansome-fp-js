# Awesome FP JS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,260 | 🐛 69 | 📅 2026-01-28 with stars
...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,609 | 🐛 110 | 🌐 JavaScript | 📅 2026-02-06 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,609 | 🐛 110 | 🌐 JavaScript | 📅 2026-02-06 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
...
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 14,757 | 🐛 61 | 🌐 TypeScript | 📅 2026-02-03 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 13,185 | 🐛 477 | 🌐 TypeScript | 📅 2026-02-13 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
...
* [Ramda Adjunct](https://github.com/char0n/ramda-adjunct) ⭐ 685 | 🐛 77 | 🌐 JavaScript | 📅 2026-02-10 is a community-maintained extension of Ramda.
...
* [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,092 | 🐛 121 | 🌐 TypeScript | 📅 2026-01-28 – Immutable persistent data collections.
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,879 | 🐛 46 | 🌐 JavaScript | 📅 2026-02-10 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
...
* [Fantasy Land](https://github.com/fantasyland/fantasy-land) ⭐ 10,223 | 🐛 36 | 🌐 JavaScript | 📅 2024-11-10 – Not a library, but a specification of the Monad laws for libraries to follow.
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,169 | 🐛 73 | 🌐 TypeScript | 📅 2025-08-20 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
* [Sanctuary](https://github.com/plaid/sanctuary) ⭐ 3,058 | 🐛 37 | 🌐 JavaScript | 📅 2024-11-10 – Sanctuary makes it possible to write safe code without null checks.  +CT, +TS.
...
* [purify](https://github.com/gigobyte/purify) ⭐ 1,594 | 🐛 2 | 🌐 TypeScript | 📅 2025-12-16 - Functional programming library for TypeScript focusing on ADTs.  +CT, +TS.
...
* [immutable-ext](https://github.com/DrBoolean/immutable-ext) ⭐ 489 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-10 – FantasyLand extensions for [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,092 | 🐛 121 | 🌐 TypeScript | 📅 2026-01-28.
...
* [xgrommx/Awesome Functional Programming](https://github.com/xgrommx/awesome-functional-programming) ⭐ 3,519 | 🐛 12 | 📅 2024-01-16 – A ton of articles on functional programming, as well as a huge list of functional libraries for many programming languages.
