# Awesome FP JS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,494 | 🐛 70 | 📅 2026-01-28 with stars
...
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 14,761 | 🐛 61 | 🌐 TypeScript | 📅 2026-02-03 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 13,194 | 🐛 477 | 🌐 TypeScript | 📅 2026-02-14 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
...
* [true-myth](https://github.com/true-myth/true-myth) ⭐ 1,318 | 🐛 14 | 🌐 TypeScript | 📅 2026-02-11 A library for safe, idiomatic null and error handling in TypeScript, with `Maybe` and `Result` types, supporting both a functional style and a more traditional method-call style
* [fxts](https://github.com/marpple/FxTS) ⭐ 1,150 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-01 - Lazy evaluation and concurrency. +TS
...
* [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,093 | 🐛 121 | 🌐 TypeScript | 📅 2026-01-28 – Immutable persistent data collections.
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,883 | 🐛 46 | 🌐 JavaScript | 📅 2026-02-10 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
...
* [Baobab](https://github.com/Yomguithereal/baobab) ⭐ 3,164 | 🐛 49 | 🌐 JavaScript | 📅 2022-05-10 – persistent and optionally immutable data tree with cursors.
...
* [prelude.ts](https://github.com/emmanueltouzery/prelude.ts) ⭐ 386 | 🐛 16 | 🌐 TypeScript | 📅 2024-03-12 - Immutable persistent collections, functional constructs such as Option and Either, and combinators. Implemented in Typescript but supports javascript too.  +CT, +TS.
...
* [Fantasy Land](https://github.com/fantasyland/fantasy-land) ⭐ 10,222 | 🐛 36 | 🌐 JavaScript | 📅 2024-11-10 – Not a library, but a specification of the Monad laws for libraries to follow.
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,173 | 🐛 73 | 🌐 TypeScript | 📅 2026-02-14 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
...
* [immutable-ext](https://github.com/DrBoolean/immutable-ext) ⭐ 489 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-10 – FantasyLand extensions for [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,093 | 🐛 121 | 🌐 TypeScript | 📅 2026-01-28.
...
* [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,379 | 🐛 8 | 🌐 Clojure | 📅 2026-02-13 – Compiles [Clojure](http://clojure.org/), a hosted Lisp with immutable persistent data structures, to JavaScript.
...
* [tk-learning-center/Functional Programming Learning Path](https://github.com/tk-learning-center/functional-programming-learning-path) ⭐ 1,037 | 🐛 1 | 🌐 Clojure | 📅 2024-10-22 - A Learning Path for Functional Programming
* [lucasviola/Awesome Functional Programming](https://github.com/lucasviola/awesome-functional-programming) ⭐ 995 | 🐛 0 | 📅 2024-04-22 – Awesome resources on functional programming theory and learning materials.
