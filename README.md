# Awesome FP JS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 467,877 | 🐛 76 | 📅 2026-05-05 with stars
...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,232 | 🐛 142 | 🌐 JavaScript | 📅 2026-05-08 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,232 | 🐛 142 | 🌐 JavaScript | 📅 2026-05-08 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
* [Ramda](https://github.com/ramda/ramda) ⭐ 24,081 | 🐛 146 | 🌐 JavaScript | 📅 2026-01-22 – A practical functional library for JavaScript that is designed specifically for a functional programming style. A style that makes it easy to create functional pipelines and never mutates user data. +TS.
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 15,000 | 🐛 68 | 🌐 TypeScript | 📅 2026-05-09 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 14,295 | 🐛 540 | 🌐 TypeScript | 📅 2026-05-18 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
* [most](https://github.com/cujojs/most) ⭐ 3,492 | 🐛 50 | 🌐 JavaScript | 📅 2022-12-06 – Ultra-high performance reactive programming to help you compose asynchronous operations on streams of values and events without many of the hazards of side effects and mutable shared state.
* [Rambda](https://github.com/selfrefactor/rambda) ⭐ 1,755 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-15 - A faster alternative to Ramda in under 10kB.
* [js-joda](https://github.com/js-joda/js-joda) ⭐ 1,660 | 🐛 15 | 🌐 JavaScript | 📅 2026-05-08 – An immutable date and time library that provides a simple, domain-driven and clean API based on the ISO8601 calendar.
...
* [true-myth](https://github.com/true-myth/true-myth) ⭐ 1,340 | 🐛 14 | 🌐 TypeScript | 📅 2026-05-18 A library for safe, idiomatic null and error handling in TypeScript, with `Maybe` and `Result` types, supporting both a functional style and a more traditional method-call style
...
* [Ramda Adjunct](https://github.com/char0n/ramda-adjunct) ⭐ 686 | 🐛 91 | 🌐 JavaScript | 📅 2026-05-09 is a community-maintained extension of Ramda.
...
* [rubico](https://github.com/a-synchronous/rubico) ⭐ 283 | 🐛 52 | 🌐 JavaScript | 📅 2026-05-14 - 🏞 \[a]synchronous functional syntax
...
* [Ditox.js](https://github.com/mnasyrov/ditox) ⭐ 102 | 🐛 1 | 🌐 TypeScript | 📅 2026-02-23 - Powerful dependency injection container for building modular apps. +TS
* [preludejs](https://github.com/alanrsoares/prelude-js) ⭐ 100 | 🐛 5 | 🌐 JavaScript | 📅 2026-05-05 - Hardcore Functional Programming for JavaScript. -TS.
...
* [fpEs](https://github.com/TeaEntityLab/fpEs/) ⭐ 43 | 🐛 5 | 🌐 JavaScript | 📅 2026-05-03 - A small library provides simple usages of basic FP & pattern-matching/sumtype & MonadIO/Rx & Optional for Javascript. -TS.
...
* [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,063 | 🐛 123 | 🌐 TypeScript | 📅 2026-05-17 – Immutable persistent data collections.
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,946 | 🐛 49 | 🌐 JavaScript | 📅 2026-05-15 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
* [Lazy.js](https://github.com/dtao/lazy.js) ⭐ 5,977 | 🐛 59 | 🌐 JavaScript | 📅 2020-07-15 – A utility library with a lazy engine under the hood that strives to do as little work as possible while being as flexible as possible.
...
* [Baobab](https://github.com/Yomguithereal/baobab) ⭐ 3,158 | 🐛 49 | 🌐 JavaScript | 📅 2022-05-10 – persistent and optionally immutable data tree with cursors.
...
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,503 | 🐛 75 | 🌐 TypeScript | 📅 2026-02-14 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
...
* [daggy](https://github.com/puffnfresh/daggy) ⭐ 706 | 🐛 2 | 🌐 JavaScript | 📅 2021-07-19 – Library for creating tagged constructors.
* [immutable-ext](https://github.com/DrBoolean/immutable-ext) ⭐ 488 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-10 – FantasyLand extensions for [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,063 | 🐛 123 | 🌐 TypeScript | 📅 2026-05-17.
...
* [lenses](https://github.com/DrBoolean/lenses) ⭐ 216 | 🐛 3 | 🌐 JavaScript | 📅 2015-09-28 – Composable [kmett](https://github.com/ekmett/lens) ⭐ 2,080 | 🐛 110 | 🌐 Haskell | 📅 2026-05-07 style lenses.
...
* [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,384 | 🐛 7 | 🌐 Clojure | 📅 2026-05-11 – Compiles [Clojure](http://clojure.org/), a hosted Lisp with immutable persistent data structures, to JavaScript.
...
* [You don't (may not) need loops ➿](https://github.com/you-dont-need/You-Dont-Need-Loops) ⭐ 1,172 | 🐛 5 | 📅 2024-10-15 - Loops are one of the first constructs that junior programmers learn, but they can pose many potential issues in the software development process, and could be avoided in many cases.
...
* [cube-composer](https://github.com/sharkdp/cube-composer) ⭐ 2,033 | 🐛 10 | 🌐 PureScript | 📅 2022-12-08 – A puzzle game inspired by functional programming.
...
* [xgrommx/Awesome Functional Programming](https://github.com/xgrommx/awesome-functional-programming) ⭐ 3,525 | 🐛 12 | 📅 2024-01-16 – A ton of articles on functional programming, as well as a huge list of functional libraries for many programming languages.
...
* [lucasviola/Awesome Functional Programming](https://github.com/lucasviola/awesome-functional-programming) ⭐ 1,006 | 🐛 1 | 📅 2024-04-22 – Awesome resources on functional programming theory and learning materials.
* [Functional Programming Resources In JavaScript](https://github.com/busypeoples/functional-programming-javascript) ⭐ 304 | 🐛 2 | 📅 2020-10-01
