# Awesome FP JS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 446,123 | 🐛 83 | 📅 2026-03-09 with stars
...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,583 | 🐛 132 | 🌐 JavaScript | 📅 2026-02-23 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,583 | 🐛 132 | 🌐 JavaScript | 📅 2026-02-23 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
...
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 14,837 | 🐛 62 | 🌐 TypeScript | 📅 2026-03-05 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 13,585 | 🐛 509 | 🌐 TypeScript | 📅 2026-03-16 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
...
* [iter-tools](https://github.com/iter-tools/iter-tools) ⭐ 184 | 🐛 16 | 🌐 JavaScript | 📅 2025-06-02 - a rich toolset for working with iterables, both sync and async. +TS.
...
* [tinyeffect](https://github.com/Snowflyt/tinyeffect) ⭐ 34 | 🐛 0 | 🌐 TypeScript | 📅 2025-03-30 - A tiny TypeScript library for handling side effects in a unified way using algebraic effects. +TS
...
* [ts-multimethod](https://github.com/darky/ts-multimethod) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-16 - TypeScript multimethods inspired by Clojure multimethods. +TS
...
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,910 | 🐛 48 | 🌐 JavaScript | 📅 2026-03-06 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
...
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,325 | 🐛 73 | 🌐 TypeScript | 📅 2026-02-14 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
...
* [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,385 | 🐛 6 | 🌐 Clojure | 📅 2026-03-08 – Compiles [Clojure](http://clojure.org/), a hosted Lisp with immutable persistent data structures, to JavaScript.
...
* [ElixirScript](https://github.com/bryanjos/elixirscript) ⭐ 1,569 | 🐛 19 | 🌐 Elixir | 📅 2019-08-20 – Compiles a subset of [Elixir](http://elixir-lang.org/), a dynamic, functional language designed for building scalable and maintainable applications, to JavaScript.
...
* [Functional Programming Jargon](https://github.com/hemanth/functional-programming-jargon) ⭐ 18,656 | 🐛 27 | 📅 2023-10-17 – Jargon from the functional programming world explained in JavaScript.
