# Awesome FP JS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 451,627 | 🐛 59 | 📅 2026-04-02 with stars
...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,518 | 🐛 134 | 🌐 JavaScript | 📅 2026-04-01 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,518 | 🐛 134 | 🌐 JavaScript | 📅 2026-04-01 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
...
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 14,913 | 🐛 64 | 🌐 TypeScript | 📅 2026-03-27 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 13,753 | 🐛 510 | 🌐 TypeScript | 📅 2026-03-31 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
...
* [js-joda](https://github.com/js-joda/js-joda) ⭐ 1,656 | 🐛 15 | 🌐 JavaScript | 📅 2026-03-31 – An immutable date and time library that provides a simple, domain-driven and clean API based on the ISO8601 calendar.
...
* [fxts](https://github.com/marpple/FxTS) ⭐ 1,154 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-27 - Lazy evaluation and concurrency. +TS
...
* [Ramda Adjunct](https://github.com/char0n/ramda-adjunct) ⭐ 685 | 🐛 87 | 🌐 JavaScript | 📅 2026-04-01 is a community-maintained extension of Ramda.
...
* [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,086 | 🐛 124 | 🌐 TypeScript | 📅 2026-03-29 – Immutable persistent data collections.
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,907 | 🐛 56 | 🌐 JavaScript | 📅 2026-04-02 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
* [Lazy.js](https://github.com/dtao/lazy.js) ⭐ 5,990 | 🐛 59 | 🌐 JavaScript | 📅 2020-07-15 – A utility library with a lazy engine under the hood that strives to do as little work as possible while being as flexible as possible.
...
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,391 | 🐛 73 | 🌐 TypeScript | 📅 2026-02-14 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
...
* [Fluture](https://github.com/Avaq/Fluture) ⭐ 2,498 | 🐛 12 | 🌐 JavaScript | 📅 2024-04-22 – A Future library with included control utilities, high performance and great error messages.
...
* [immutable-ext](https://github.com/DrBoolean/immutable-ext) ⭐ 489 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-10 – FantasyLand extensions for [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,086 | 🐛 124 | 🌐 TypeScript | 📅 2026-03-29.
...
* [lenses](https://github.com/DrBoolean/lenses) ⭐ 216 | 🐛 3 | 🌐 JavaScript | 📅 2015-09-28 – Composable [kmett](https://github.com/ekmett/lens) ⭐ 2,079 | 🐛 110 | 🌐 Haskell | 📅 2026-03-02 style lenses.
...
* [Functional Programming Jargon](https://github.com/hemanth/functional-programming-jargon) ⭐ 18,643 | 🐛 27 | 📅 2023-10-17 – Jargon from the functional programming world explained in JavaScript.
