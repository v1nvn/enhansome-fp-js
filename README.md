# Awesome FP JS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,153 | 🐛 70 | 📅 2026-01-28 with stars
...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,616 | 🐛 111 | 🌐 JavaScript | 📅 2026-02-06 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,616 | 🐛 111 | 🌐 JavaScript | 📅 2026-02-06 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
* [Ramda](https://github.com/ramda/ramda) ⭐ 24,102 | 🐛 146 | 🌐 JavaScript | 📅 2026-01-22 – A practical functional library for JavaScript that is designed specifically for a functional programming style. A style that makes it easy to create functional pipelines and never mutates user data. +TS.
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 14,769 | 🐛 61 | 🌐 TypeScript | 📅 2026-02-03 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 13,221 | 🐛 482 | 🌐 TypeScript | 📅 2026-02-17 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
...
* [rubico](https://github.com/a-synchronous/rubico) ⭐ 282 | 🐛 57 | 🌐 JavaScript | 📅 2026-02-17 - 🏞 \[a]synchronous functional syntax
...
* [tinyeffect](https://github.com/Snowflyt/tinyeffect) ⭐ 32 | 🐛 0 | 🌐 TypeScript | 📅 2025-03-30 - A tiny TypeScript library for handling side effects in a unified way using algebraic effects. +TS
...
* [prelude.ts](https://github.com/emmanueltouzery/prelude.ts) ⭐ 389 | 🐛 16 | 🌐 TypeScript | 📅 2024-03-12 - Immutable persistent collections, functional constructs such as Option and Either, and combinators. Implemented in Typescript but supports javascript too.  +CT, +TS.
...
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,183 | 🐛 74 | 🌐 TypeScript | 📅 2026-02-14 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
...
* [purify](https://github.com/gigobyte/purify) ⭐ 1,595 | 🐛 2 | 🌐 TypeScript | 📅 2025-12-16 - Functional programming library for TypeScript focusing on ADTs.  +CT, +TS.
...
* [lenses](https://github.com/DrBoolean/lenses) ⭐ 216 | 🐛 3 | 🌐 JavaScript | 📅 2015-09-28 – Composable [kmett](https://github.com/ekmett/lens) ⭐ 2,076 | 🐛 110 | 🌐 Haskell | 📅 2026-01-10 style lenses.
...
* [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,382 | 🐛 8 | 🌐 Clojure | 📅 2026-02-13 – Compiles [Clojure](http://clojure.org/), a hosted Lisp with immutable persistent data structures, to JavaScript.
* [GHCJS](https://github.com/ghcjs/ghcjs) ⭐ 2,618 | 🐛 295 | 🌐 Haskell | 📅 2023-01-21 – [Haskell](https://www.haskell.org/) to JavaScript compiler, based on GHC.
