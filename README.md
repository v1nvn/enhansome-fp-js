# Awesome FP JS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,047 | 🐛 69 | 📅 2026-01-28 with stars
...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,617 | 🐛 109 | 🌐 JavaScript | 📅 2026-02-06 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,617 | 🐛 109 | 🌐 JavaScript | 📅 2026-02-06 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
* [Ramda](https://github.com/ramda/ramda) ⭐ 24,105 | 🐛 147 | 🌐 JavaScript | 📅 2026-01-22 – A practical functional library for JavaScript that is designed specifically for a functional programming style. A style that makes it easy to create functional pipelines and never mutates user data. +TS.
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 14,753 | 🐛 61 | 🌐 TypeScript | 📅 2026-02-03 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 13,180 | 🐛 479 | 🌐 TypeScript | 📅 2026-02-12 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
...
* [true-myth](https://github.com/true-myth/true-myth) ⭐ 1,316 | 🐛 14 | 🌐 TypeScript | 📅 2026-02-11 A library for safe, idiomatic null and error handling in TypeScript, with `Maybe` and `Result` types, supporting both a functional style and a more traditional method-call style
...
* [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,101 | 🐛 121 | 🌐 TypeScript | 📅 2026-01-28 – Immutable persistent data collections.
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,880 | 🐛 46 | 🌐 JavaScript | 📅 2026-02-10 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
...
* [Mori](https://github.com/swannodette/mori) ⭐ 3,375 | 🐛 63 | 🌐 Clojure | 📅 2020-04-19 – ClojureScript’s persistent data structures and supporting API from the comfort of vanilla JavaScript.
...
* [imlazy](https://github.com/benji6/imlazy) ⭐ 104 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-09 – Library for creating and manipulating lazy iterables using the ES2015 iteration protocols.
...
* [Fantasy Land](https://github.com/fantasyland/fantasy-land) ⭐ 10,225 | 🐛 36 | 🌐 JavaScript | 📅 2024-11-10 – Not a library, but a specification of the Monad laws for libraries to follow.
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,166 | 🐛 72 | 🌐 TypeScript | 📅 2025-08-20 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
...
* [immutable-ext](https://github.com/DrBoolean/immutable-ext) ⭐ 489 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-10 – FantasyLand extensions for [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,101 | 🐛 121 | 🌐 TypeScript | 📅 2026-01-28.
...
* [lenses](https://github.com/DrBoolean/lenses) ⭐ 216 | 🐛 3 | 🌐 JavaScript | 📅 2015-09-28 – Composable [kmett](https://github.com/ekmett/lens) ⭐ 2,078 | 🐛 110 | 🌐 Haskell | 📅 2026-01-10 style lenses.
